...
/**
 * Configures the wso2 features with shindig.
 */
public class WSO2ShindigFeaturesModule extends AbstractModule {

    /**
     * Adds the features-features directory to the search path
     */
    @Override
    protected void configure() {
        ...
        featureBinder.addBinding().toInstance("res://wso2features/features.txt");
    }
}
