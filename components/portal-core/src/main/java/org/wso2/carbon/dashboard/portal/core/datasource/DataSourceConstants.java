...
class DataSourceConstants {
    ...
    /*static final String SQL_UPDATE_USERS_NOTIFICATION = "UPDATE USER_NOTIFICATION SET READ = ? WHERE USER_ID = ? AND NOTIFICATION_ID = ? AND TENANT_ID=?";
    static final String SQL_INSERT_INTO_NOTIFICATION = "INSERT INTO NOTIFICATION (NOTIFICATION_ID,TITLE, MESSAGE,DIRECT_URL, USER_COUNT, READ_COUNT) VALUES " +
            "(?,?,?,?,?,?)";
    static final String SQL_INSERT_INTO_USER_NOTIFICATION = "INSERT INTO USER_NOTIFICATION (NOTIFICATION_ID, USER_NAME,READ) VALUES" +
            "(?,?,?)";
    static final String SQL_INSERT_INTO_ROLE_NOTIFICATION = "INSERT INTO ROLE_NOTIFICATION (NOTIFICATION_ID, ROLE) VALUES "+
            "(?,?)";
    public static final String CREATE_USER_NOTIFICATION_TABLE = "CREATE TABLE IF NOT EXISTS USER_NOTIFICATION_";

    public static final String TABLE_ATTRIBUTES = " ( USERNAME VARCHAR (255) NOT NULL, NOTIFICATIONS TEXT," +
            " PRIMARY KEY(USERNAME) ) ;";
    public static final String DB_CHECK_USER_NOTIFICATION_TABLE = "SELECT * FROM USER_NOTIFICATION_";

    public static final String SQL_GET_NOTIFICATION_LIST_TABLE = "SELECT NOTIFICATIONS FROM USER_NOTIFICATION_";
    public static final String REMAINING_SQL_GET_NOTIFICATION_LIST = " WHERE USERNAME=?";

    public static final String SQL_UPDATE_NOTIFICATION_LIST_TABLE = "INSERT INTO USER_NOTIFICATION_";
    public static final String REMAINING_SQL_UPDATE_NOTIFICATION_LIST = " (NOTIFICATIONS) VALUES ? WHERE USENAME=?";

    static final String SQL_GET_NOTIFICATIONS_FOR_USER_NAME = "SELECT NOTIFICATION_ID FROM USER_NOTIFICATION WHERE USER_NAME=?";
    static final String SQL_GET_NOTIFICATIONS_FOR_ROLE = "SELECT NOTIFICATION_ID FROM ROLE_NOTIFICATION WHERE ROLE=?";
    static final String SQL_GET_NOTIFICATION_DETAILS =  "SELECT TITLE, MESSAGE, DIRECT_URL FROM NOTIFICATION WHERE NOTIFICATION_ID=?";
    static  final String SQL_GET_UNREAD_NOTIFICATION_COUNT = "SELECT COUNT(NOTIFICATION_ID) FROM USER_NOTIFICATION WHERE READ=FALSE AND USER_NAME = ? ";
    static  final String SQL_GET_NOTIFICATION_COUNT = "SELECT COUNT(NOTIFICATION_ID) FROM USER_NOTIFICATION WHERE USER_NAME = ? ";*/
