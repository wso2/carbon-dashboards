...
class DataSourceConstants {
    ...
    static final String SQL_INSERT_INTO_NOTIFICATION = "INSERT INTO NOTIFICATION (NOTIFICATION_ID,TITLE, MESSAGE,DIRECT_URL) VALUES " +
            "(?,?,?,?)";
    ...
    static final String SQL_INSERT_INTO_ROLE_NOTIFICATION = "INSERT INTO ROLE_NOTIFICATION (NOTIFICATION_ID, ROLE) VALUES "+
            "(?,?)";
    /*static final String SQL_GET_ROLES_FOR_NOTIFICATION = "SELECT ROLE FROM ROLE_NOTIFICATION WHERE NOTIFICATION_ID=? AND TENANT_ID=?";
    static final String SQL_GET_USERS_FOR_NOTIFICATION = "SELECT USER_ID FROM USER_NOTIFICATION WHERE NOTIFICATION_ID=? AND TENANT_ID=?";*/
    ...
    static  final String SQL_GET_NOTIFICATION_COUNT = "SELECT COUNT(NOTIFICATION_ID) FROM USER_NOTIFICATION WHERE READ=FALSE AND USER_NAME = ? ";
