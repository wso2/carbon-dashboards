...
(function () {
    ...
    var renderChart = function (containerId) {
        ...
        widget.renderer.setWidgetName(
            portal.dashboards.widgets['org.wso2.carbon.dashboards.designer.widget-state'].info.id,
            portal.dashboards.widgets['org.wso2.carbon.dashboards.designer.widget-state'].info.name);
    ...
    portal.dashboards.widgets['org.wso2.carbon.dashboards.designer.widget-state'].actions = {
        render: render
    };
}());