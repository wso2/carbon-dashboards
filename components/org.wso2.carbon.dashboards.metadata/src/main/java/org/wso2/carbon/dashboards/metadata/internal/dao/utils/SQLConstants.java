...
public class SQLConstants {
    ...
    public static final String GET_METADATA_BY_NAME = "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, "
            + "DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, "
            + "DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT " +
    ...
    public static final String LIST_METADATA_QUERY = "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, "
            + "DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, "
            + "DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT "
            + "FROM DASHBOARD_RESOURCE";

    public static final String GET_METADATA_BY_NAME_AND_VERSION = "SELECT DASHBOARD_ID, DASHBOARD_URL, "
            + "DASHBOARD_NAME, DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, "
            + "DASHBOARD_SHARED, DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, "
            + "DASHBOARD_CONTENT FROM DASHBOARD_RESOURCE WHERE DASHBOARD_NAME = ? AND DASHBOARD_VERSION = ?";

    public static final String GET_METADATA_BY_OWNER_AND_NAME = "SELECT DASHBOARD_ID, DASHBOARD_ID, DASHBOARD_URL, "
            + "DASHBOARD_NAME, DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, "
            + "DASHBOARD_SHARED, DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, "
            + "DASHBOARD_CONTENT FROM DASHBOARD_RESOURCE WHERE DASHBOARD_OWNER = ? AND DASHBOARD_NAME = ?";

    public static final String GET_METADATA_BY_URL_AND_VERSION = "SELECT DASHBOARD_ID, DASHBOARD_URL, "
            + "DASHBOARD_NAME, DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, "
            + "DASHBOARD_SHARED, DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, "
            + "DASHBOARD_CONTENT FROM DASHBOARD_RESOURCE WHERE DASHBOARD_URL = ? AND DASHBOARD_VERSION = ?";
