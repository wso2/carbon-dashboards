            ...
            var fn = {
                id: function () {
                    ...
                    if (checkForPagesById(idVal) && page.id != idVal) {
                        generateMessage("A page with entered URL already exists. Please select a different URL", null, null, "error", "topCenter", 3500, ['button', 'click']);
                        id.val(page.id);
                    } else {
                        page.id = idVal;
                ...
                title: function () {
                    ...
                    if (checkForPagesByTitle(titleVal) && page.title.toUpperCase() != titleVal.toUpperCase()) {
                        generateMessage("A page with entered title already exists. Please select a different title", null, null, "error", "topCenter", 3500, ['button', 'click']);
