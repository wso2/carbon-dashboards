...
class RevenuePerYear extends Widget {
    constructor(props) {
        super(props);
        this.totalCustomerData = [
            ['2013', 'ALL', 1902348, 182, 106],
            ['2014', 'ALL', 5693122.5, 578, 354],
            ['2015', 'ALL', 3161485.5, 334, 211],
            ['2016', 'ALL', 3002843, 341, 226],
            ['2017', 'ALL', 5717110.04, 388, 173]
        ];

        this.lineConfig = {
            x: 'Year',
            charts: [{type: 'line', y: 'Revenue', fill: '#7f39c1',style:{strokeWidth:2,markRadius:5}}],
...
global.dashboard.registerWidget("RevenuePerYear", RevenuePerYear);